...
- `osl-report`：共享报告 DTO 与 HTML/JSON/JUnit XML renderer，当前已承接 verify/bench 报告页面、CI JUnit 输出和 artifact drilldown 链接；后续扩展 Markdown 和 GUI report viewer。
