...
- `osl-report`：共享报告 DTO、HTML/JSON/Markdown/JUnit XML renderer、verify/bench bundle writer 和目录级 report writer，当前已承接报告页面、代码评审 Markdown、CI JUnit 输出、已有 HTML report 复用和 artifact drilldown 链接；后续扩展 GUI report viewer。
