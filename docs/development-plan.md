...
- 实现 symbol library index、library table 解析、symbol graphics / pin / property / unit 支持；保留 `.kicad_sym` symbol graphics 的 stroke/fill/private/UUID/locked 元数据，以及 symbol-level pin name/number 显示设置和 pin name/number text effects。
