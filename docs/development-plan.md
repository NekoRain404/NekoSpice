...
- `osl-report`：共享报告 DTO 与 HTML/JSON renderer，当前已承接 verify/bench 报告页面和 artifact drilldown 链接；后续扩展 Markdown、JUnit XML 和 GUI report viewer。
