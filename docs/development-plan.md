...
- waveform renderer。
- schematic canvas renderer：symbol、symbol graphics、schematic-level drawing primitives、wire、bus、label、schematic text/SPICE directive text、text box、junction、no-connect、sheet、selection、grid。
- 缩放、平移、游标、marker。
- 多曲线叠加。
- sweep 分组显示。
