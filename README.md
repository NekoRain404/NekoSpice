...
- `nekospice`: hardware-accelerated GUI alpha using egui on wgpu, loading KiCad schematic canvas scenes through the same Rust-native IR and selection backend.
