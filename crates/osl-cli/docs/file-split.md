...
原始 `main.rs` 长达 ~1920 行，包含 CLI 调度、KiCad 命令和验证基础设施。
...
### cli_kicad.rs
- `kicad_inspect_command` — 原理图检查
- `kicad_select_command` — 符号选择
- `kicad_check_command` — 诊断检查
- `kicad_export_command` — 导出
- `kicad_edit_command` — 编辑操作
- `kicad_render_command` — SVG 渲染
