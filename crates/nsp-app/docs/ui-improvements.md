...
| Schematic | ◎ | Schema-compatible editing |
...
### Color Philosophy
- Canvas background is always light (Schema convention: `rgb(236, 240, 244)`)
- UI panels use dark backgrounds regardless of theme mode
- Accent color: GitHub blue (`rgb(56, 139, 253)`) in Midnight
- Schematic elements use Schema standard colors (green wires, blue buses)

## Canvas Rendering (`canvas/`)

### Grid
- Minor lines: 2.54mm (100mil) step — aligns with Schema schematic grid
...
- Font size from Schema text effects (fallback: 8pt name, 7pt number)
