...
All GUI composition is separated from format data adapters and canvas rendering helpers.
...
├── document.rs              # NspGuiDocument: load/save/edit schematics
├── library.rs               # NspGuiLibrary: symbol library browser adapter
...
│   ├── colors.rs            # Schematic color palette (standard)
