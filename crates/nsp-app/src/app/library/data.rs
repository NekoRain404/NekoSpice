...
impl NekoSpiceApp {
    ...
    pub(crate) fn filtered_library_symbols(&self) -> Vec<NspIndexedSymbol> {
        self.library
            .as_ref()
    ...
    pub(crate) fn selected_library_symbol_snapshot(&self) -> Option<NspIndexedSymbol> {
...
/// spice preview lines。
pub(crate) fn spice_preview_lines(symbol: &NspIndexedSymbol) -> Vec<String> {
    ...
    vec![
        ...
        "* schema symbol preview generated by NekoSpice".to_string(),
...
impl NekoSpiceApp {
    ...
    pub(crate) fn import_vendor_models(&mut self, path: &str) {
        ...
        match nsp_model::import_spice_model_dir(&path) {
            Ok(results) => {
                let catalog = nsp_model::build_model_catalog(&results);
    ...
    pub(crate) fn import_vendor_model_file(&mut self, path: &str) {
        ...
        match nsp_model::import_spice_model_file(&path) {
            Ok(result) => {
    ...
    /// 搜索厂商模型
    #[allow(dead_code)]
    pub(crate) fn filtered_vendor_models(&self) -> &nsp_model::VendorModelCatalog {
