...
fn profile_analysis_modes() -> [(NspSimulationDirectiveKind, &'static str, &'static str); 7] {
    [
        (NspSimulationDirectiveKind::Tran, ".tran", "time domain"),
        (NspSimulationDirectiveKind::Ac, ".ac", "small signal"),
        (NspSimulationDirectiveKind::Dc, ".dc", "sweep"),
        (NspSimulationDirectiveKind::Op, ".op", "operating point"),
        (NspSimulationDirectiveKind::Noise, ".noise", "noise"),
        (NspSimulationDirectiveKind::Disto, ".disto", "distortion"),
        (NspSimulationDirectiveKind::Sens, ".sens", "sensitivity"),
    ]
}
