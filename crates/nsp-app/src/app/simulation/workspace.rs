        ...
        ui.columns(4, |columns| {
            ...
            solver_metric_card(
                ...
                match self.simulation_panel.directive_kind {
                    nsp_schema::NspSimulationDirectiveKind::Tran => "time domain",
                    nsp_schema::NspSimulationDirectiveKind::Ac => "small signal",
                    nsp_schema::NspSimulationDirectiveKind::Dc => "sweep",
                    nsp_schema::NspSimulationDirectiveKind::Op => "operating point",
                    nsp_schema::NspSimulationDirectiveKind::Noise => "noise analysis",
                    _ => "",
                },
            );
            solver_metric_card(
