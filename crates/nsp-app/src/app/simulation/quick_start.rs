...
struct QuickTemplate {
    ...
    analysis_kind: NspSimulationDirectiveKind,
...
fn templates() -> Vec<QuickTemplate> {
    vec![
        ...
        QuickTemplate {
            ...
            analysis_kind: NspSimulationDirectiveKind::Tran,
        ...
        QuickTemplate {
            ...
            analysis_kind: NspSimulationDirectiveKind::Ac,
        ...
        QuickTemplate {
            ...
            analysis_kind: NspSimulationDirectiveKind::Dc,
            make_params: dc_transfer_params,
        },
        QuickTemplate {
            name: "Operating Point",
            description: "DC bias point analysis",
            analysis_kind: NspSimulationDirectiveKind::Op,
