...
pub(crate) fn analysis_modes() -> [(
    nsp_schema::NspSimulationDirectiveKind,
    &'static str,
    &'static str,
); 7] {
    [
        ...
        (nsp_schema::NspSimulationDirectiveKind::Dc, ".dc", "sweep"),
        (
        ...
        (
            nsp_schema::NspSimulationDirectiveKind::Disto,
            ".disto",
            "distortion",
        ),
        (
            nsp_schema::NspSimulationDirectiveKind::Sens,
            ".sens",
            "sensitivity",
        ),
    ]
