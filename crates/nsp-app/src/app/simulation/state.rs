...
pub(crate) struct SimulationPanelState {
    ...
    pub(crate) directive_kind: NspSimulationDirectiveKind,
...
impl Default for SimulationPanelState {
    fn default() -> Self {
        Self {
            directive_kind: NspSimulationDirectiveKind::Tran,
...
impl SimulationPanelState {
    ...
    pub(crate) fn from_disk() -> Self {
        ...
        let directive_kind: NspSimulationDirectiveKind = directive_str
            .parse()
            .unwrap_or(NspSimulationDirectiveKind::Tran);
