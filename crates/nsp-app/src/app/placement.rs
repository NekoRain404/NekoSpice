...
use nsp_schema::{NspAt, NspCanvasHit, NspCanvasScene, NspPoint};
...
impl NekoSpiceApp {
    ...
    pub(super) fn place_selected_symbol_at_point(&mut self, point: NspPoint) {
...
fn hit_for_symbol_reference(scene: &NspCanvasScene, reference: &str) -> Option<NspCanvasHit> {
    let symbol = scene
        .symbols
        .iter()
