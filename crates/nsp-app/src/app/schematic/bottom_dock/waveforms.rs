...
//! FFT and Bode use the real FFT engine from `nsp_waveform::fft`.
...
fn compute_preview_fft(
...
) -> Option<Vec<nsp_waveform::fft::FftBin>> {
    ...
    Some(nsp_waveform::fft::compute_fft_bins(
        &samples,
        dt,
        nsp_waveform::fft::WindowFunction::Hanning,
    ))
}
...
fn draw_fft_trace(
    ...
    bins: &[nsp_waveform::fft::FftBin],
    get_value: impl Fn(&nsp_waveform::fft::FftBin) -> f64,
