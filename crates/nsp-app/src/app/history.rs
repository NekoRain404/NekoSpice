...
impl EditHistory {
    ...
    pub(super) fn push(&mut self, snapshot: NspSchematic) {
    ...
    pub(super) fn undo(&mut self, current: NspSchematic) -> Option<NspSchematic> {
    ...
    pub(super) fn redo(&mut self, current: NspSchematic) -> Option<NspSchematic> {
...
mod tests {
    ...
    fn empty_schematic() -> NspSchematic {
        NspSchematic {
            source: String::new(),
            version: None,
            generator: None,
