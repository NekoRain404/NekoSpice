...
use nsp_schema::{NspBoundingBox, NspCanvasBusEntry, NspPoint};
...
/// Draw a polyline (open or closed) from world-space schema points.
...
pub(super) fn quadratic_bezier_sample(points: &[NspPoint], segments: usize) -> Vec<NspPoint> {
    if points.len() < 3 {
