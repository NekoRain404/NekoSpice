...
//!
//! The crate keeps GUI composition separate from schema document/library adapters
//! and canvas viewport/rendering helpers, so future schematic editing tools can
//! grow without coupling UI widgets directly to schema file internals.
...
#[allow(dead_code)]
pub(crate) const DEFAULT_SCHEMATIC: &str = "examples/schema_schematic/rc.kicad_sch";
...
/// GUI startup schematic -- CM5 Minima demo board (schema demo project).
