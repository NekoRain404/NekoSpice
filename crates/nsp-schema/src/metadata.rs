...
pub struct NspTitleBlock {
    pub title: Option<String>,
    pub date: Option<String>,
    pub revision: Option<String>,
    pub company: Option<String>,
    pub comments: Vec<NspTitleComment>,
}
...
#[derive(Debug, Clone, PartialEq)]
pub struct NspTitleComment {
    pub index: u32,
    pub text: String,
}

/// parse title block。
pub(crate) fn parse_title_block(node: &Sexp) -> NspTitleBlock {
...
fn parse_title_comment(node: &Sexp) -> Option<NspTitleComment> {
    Some(NspTitleComment {
