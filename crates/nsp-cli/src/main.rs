...
fn run_cli() -> OslResult<i32> {
    ...
    match command.as_str() {
        ...
        "schema-inspect" => schema_inspect_command(&args),
        "schema-select" => schema_select_command(&args),
        "schema-check" => schema_check_command(&args),
        "schema-export" => schema_export_command(&args),
        "schema-edit" => schema_edit_command(&args),
        "schema-render" => schema_render_command(&args),
...
Usage:
  ...
  osl import <spice-netlist-or-ltspice.asc-or-schema_sch-or-schema-project> [--output <dir>]
  osl schema-inspect <file.kicad_pro-or-file.kicad_sch-or-file.kicad_sym-or-sym-lib-table> [--canvas] [--index] [--output <file>]
  osl schema-select <file.kicad_sch> <x,y> [--output <file>]
  osl schema-check <file.kicad_sch> [--output <file>]
  osl schema-export <file.kicad_sch-or-file.kicad_sym> --output <file>
  osl schema-edit <file.kicad_sch> --output <file.kicad_sch> [--library <file.kicad_sym>] <ops...>
      delete-item:<uuid>
  ...
  osl schema-render <file.kicad_sch-or-file.kicad_sym> [--symbol <name>] [--unit <n>] [--body-style <n>] --output <file.svg>
