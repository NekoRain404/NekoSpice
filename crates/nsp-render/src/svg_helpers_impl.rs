...
mod tests {
    ...
    fn renders_schema_canvas_scene_to_svg() {
        let workspace_root = Path::new(env!("CARGO_MANIFEST_DIR"))
            ...
            .unwrap();
        let schematic =
            read_schematic(&workspace_root.join("examples/schema_schematic/rc.nsp_sch"))
                .unwrap();
  ...
  (sheet
    ...
    (pin "out" output (at 35 15 0))
        ...
        assert!(svg.contains("gain_stage.nsp_sch"));
