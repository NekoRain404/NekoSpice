...
use nsp_core::{Artifact, OslError, OslResult, RunMetadata, RunStatus, html_escape, write_text};
use nsp_waveform::read_ngspice_raw;
use std::fs;
use std::path::Path;
...
mod tests {
    ...
    use nsp_core::{ParameterOverride, RunMetadata, RunStatus, write_text};
    use std::fs;
...
"#;
    ...
    fn test_metadata(output_dir: &std::path::Path) -> RunMetadata {
        RunMetadata {
            ...
            artifacts: vec![nsp_core::Artifact {
