...
All GUI composition is separated from KiCad data adapters and canvas rendering helpers.
...
│   ├── colors.rs            # Schematic color palette (KiCad standard)
...
1. **Decoupling**: GUI composition never directly references KiCad file internals.
