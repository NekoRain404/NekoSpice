...
pub(super) fn section_header(ui: &mut egui::Ui, mode: StudioThemeMode, title: &str) {
...
#[allow(dead_code)]
pub(super) fn status_pill(ui: &mut egui::Ui, mode: StudioThemeMode, label: &str, ok: bool) {
