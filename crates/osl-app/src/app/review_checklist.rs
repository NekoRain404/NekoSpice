...
use super::review_workspace_state::ReviewChecklistTab;
use super::theme::{StudioTheme, StudioThemeMode};
use eframe::egui::{self, Color32, RichText};

impl NekoSpiceApp {
    pub(super) fn draw_review_checklist_board(&mut self, ui: &mut egui::Ui) {
...
const REVIEW_CHECKLIST: [ChecklistItem; 9] = [
    ChecklistItem {
        ...
        title_en: "Schematic parses as KiCad document",
        title_zh: "原理图可解析为 KiCad 文档",
