...
pub(super) fn property_row(ui: &mut egui::Ui, mode: StudioThemeMode, label: &str, value: &str) {
    let palette = StudioTheme::palette(mode);
    ui.horizontal(|ui| {
...
pub(super) fn status_pill(ui: &mut egui::Ui, mode: StudioThemeMode, label: &str, color: Color32) {
    let palette = StudioTheme::palette(mode);
    egui::Frame::new()
...
pub(super) fn compact_action(ui: &mut egui::Ui, mode: StudioThemeMode, label: &str) -> bool {
    let palette = StudioTheme::palette(mode);
    ui.add(
...
pub(super) fn section_caption(ui: &mut egui::Ui, mode: StudioThemeMode, text: &str) {
