...
use super::review_workspace_state::ReviewSeverityFilter;
use super::review_workspace_widgets::{
...
use super::waveform_preview::draw_stacked_waveform_preview;
use crate::waveform_summary::GuiWaveformSummaryState;
use eframe::egui;

impl NekoSpiceApp {
    pub(super) fn draw_review_center_workspace(&mut self, ui: &mut egui::Ui) {
    ...
    pub(super) fn draw_review_workspace_panel(&mut self, ui: &mut egui::Ui) {
        let mode = self.theme_mode();
