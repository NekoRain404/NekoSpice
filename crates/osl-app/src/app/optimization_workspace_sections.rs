...
use super::optimization_workspace_state::OptimizationTab;
use super::optimization_workspace_widgets::{
...
impl NekoSpiceApp {
    pub(super) fn draw_optimization_tabs(&mut self, ui: &mut egui::Ui) {
    ...
    pub(super) fn draw_optimization_main_panel(&self, ui: &mut egui::Ui) {
    ...
    pub(super) fn draw_targets_panel(&self, ui: &mut egui::Ui) {
    ...
    pub(super) fn draw_sweep_panel(&self, ui: &mut egui::Ui) {
        let mode = self.theme_mode();
        StudioTheme::panel_frame_for(mode).show(ui, |ui| {
            ui.label(StudioTheme::section_title_for(
                mode,
    ...
    pub(super) fn draw_monte_carlo_panel(&self, ui: &mut egui::Ui) {
        let mode = self.theme_mode();
        StudioTheme::panel_frame_for(mode).show(ui, |ui| {
            ui.label(StudioTheme::section_title_for(
                mode,
    ...
    pub(super) fn draw_optimization_summary_panel(&self, ui: &mut egui::Ui) {
        let mode = self.theme_mode();
        StudioTheme::panel_frame_for(mode).show(ui, |ui| {
            ui.label(StudioTheme::section_title_for(
                mode,
