...
pub(crate) struct SchematicToolState {
    ...
    pub(crate) sheet_size: KicadSize,
    pub(crate) sheet_pin_names: [String; 2],
    pub(crate) pending_wire_start: Option<KicadPoint>,
    pub(crate) pending_bus_start: Option<KicadPoint>,
    pub(crate) bus_entry_size: KicadSize,
}
