...
pub(crate) fn canvas_toolbar_button(
    ui: &mut egui::Ui,
...
pub(crate) fn toolbar_icon_button_active(
    ui: &mut egui::Ui,
    mode: StudioThemeMode,
    icon: &str,
    tooltip: &str,
...
pub(crate) fn bottom_console_line(
    ui: &mut egui::Ui,
...
#[allow(dead_code)]
pub(crate) fn toolbar_separator_dot(ui: &mut egui::Ui, mode: StudioThemeMode) {
    let palette = StudioTheme::palette(mode);
    ui.label(
