...
pub(super) fn draw_plot_grid(painter: &egui::Painter, rect: Rect, color: Color32) {
    for index in 1..5 {
...
pub(super) fn draw_waveform_zero_axis(
...
pub(super) fn draw_waveform_buckets(
    painter: &egui::Painter,
    rect: Rect,
    preview: &GuiWaveformPreview,
    color: Color32,
...
pub(super) fn trace_color(mode: StudioThemeMode, index: usize) -> Color32 {
...
pub(super) fn plot_fill(mode: StudioThemeMode) -> Color32 {
    let palette = StudioTheme::palette(mode);
...
pub(super) fn format_compact_f64(value: f64) -> String {
    if !value.is_finite() {
