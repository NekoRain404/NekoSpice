...
use super::schematic_inspector_widgets::{
...
impl NekoSpiceApp {
    pub(super) fn draw_schematic_properties_tab(&mut self, ui: &mut egui::Ui) {
    ...
    pub(super) fn draw_schematic_kicad_inspector_tab(&mut self, ui: &mut egui::Ui) {
        let mode = self.theme_mode();
        StudioTheme::panel_frame_for(mode).show(ui, |ui| {
            ui.label(StudioTheme::section_title_for(
                mode,
    ...
    pub(super) fn draw_schematic_libraries_tab(&mut self, ui: &mut egui::Ui) {
        let mode = self.theme_mode();
        StudioTheme::panel_frame_for(mode).show(ui, |ui| {
            ui.label(StudioTheme::section_title_for(
                mode,
