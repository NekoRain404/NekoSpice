use super::review_workspace_state::{ReviewSeverity, ReviewSeverityFilter};
...
pub(super) const REVIEW_FINDINGS: [ReviewFinding; 4] = [
    ReviewFinding {
...
pub(super) fn severity_color(palette: StudioPalette, severity: ReviewSeverity) -> Color32 {
    match severity {
...
pub(super) fn review_metric_row(
    ui: &mut egui::Ui,
...
pub(super) fn review_filter_row(
    ui: &mut egui::Ui,
    mode: StudioThemeMode,
...
pub(super) fn review_recommendation_row(
    ui: &mut egui::Ui,
    mode: StudioThemeMode,
    title: &str,
    detail: &str,
