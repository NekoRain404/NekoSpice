...
use super::waveform_preview::format_compact_f64;
use crate::waveform_summary::GuiWaveformVariableSummary;
use eframe::egui::{self, RichText};

pub(super) fn waveform_mode_tab(
    ui: &mut egui::Ui,
...
pub(super) fn waveform_empty_state(
    ui: &mut egui::Ui,
    mode: StudioThemeMode,
    title: &str,
    caption: &str,
...
pub(super) fn measurement_table(
    ui: &mut egui::Ui,
...
pub(super) struct MeasurementTableLabels<'a> {
    pub(super) signal: &'a str,
    pub(super) last: &'a str,
    pub(super) average: &'a str,
    pub(super) rms: &'a str,
    pub(super) peak_to_peak: &'a str,
    pub(super) samples: &'a str,
    pub(super) more_variables: &'a str,
}

pub(super) fn run_stat_row(ui: &mut egui::Ui, mode: StudioThemeMode, label: &str, value: &str) {
    let palette = StudioTheme::palette(mode);
    ui.horizontal(|ui| {
...
pub(super) fn waveform_summary_card(
    ui: &mut egui::Ui,
    mode: StudioThemeMode,
    title: &str,
    status: &str,
