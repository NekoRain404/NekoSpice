...
pub(super) use super::waveform_preview_primitives::format_compact_f64;
use super::waveform_preview_primitives::{
...
pub(super) fn draw_single_waveform_preview(
    ui: &mut egui::Ui,
...
pub(super) fn draw_stacked_waveform_preview(
    ui: &mut egui::Ui,
    mode: StudioThemeMode,
