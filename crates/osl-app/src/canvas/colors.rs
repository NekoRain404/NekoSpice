...
impl SchematicColors {
    ...
    fn dark() -> Self {
        Self {
            canvas_bg: Color32::from_rgb(18, 22, 30),
            grid_minor: Color32::from_rgb(28, 34, 46),
            grid_major: Color32::from_rgb(36, 44, 58),
            wire: Color32::from_rgb(40, 200, 110),
            junction: Color32::from_rgb(40, 200, 110),
            bus: Color32::from_rgb(100, 140, 255),
            bus_entry: Color32::from_rgb(100, 140, 255),
            symbol_body: Color32::from_rgb(195, 205, 220),
            symbol_pin: Color32::from_rgb(180, 195, 215),
            symbol_pin_name: Color32::from_rgb(160, 175, 200),
            symbol_pin_number: Color32::from_rgb(120, 140, 170),
            symbol_reference: Color32::from_rgb(195, 205, 220),
            symbol_value: Color32::from_rgb(150, 165, 190),
            label_local: Color32::from_rgb(80, 160, 255),
            label_global: Color32::from_rgb(60, 140, 240),
            label_hierarchical: Color32::from_rgb(180, 120, 220),
            label_directive: Color32::from_rgb(210, 160, 60),
            label_directive_bounds: Color32::from_rgb(180, 130, 45),
            text: Color32::from_rgb(180, 195, 215),
            text_spice_directive: Color32::from_rgb(220, 100, 100),
            text_box_border: Color32::from_rgb(100, 115, 140),
            sheet_fill: Color32::from_rgb(22, 30, 44),
            sheet_border: Color32::from_rgb(100, 140, 200),
            sheet_name: Color32::from_rgb(100, 150, 220),
            sheet_pin: Color32::from_rgb(80, 160, 255),
            rule_area: Color32::from_rgb(200, 160, 50),
            no_connect: Color32::from_rgb(180, 195, 215),
            graphic: Color32::from_rgb(140, 155, 180),
            hover_highlight: Color32::from_rgba_premultiplied(50, 140, 255, 90),
            selection: Color32::from_rgb(50, 140, 255),
            placement_preview: Color32::from_rgb(80, 140, 220),
        }
    }
}
