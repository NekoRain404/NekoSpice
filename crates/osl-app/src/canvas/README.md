...
```
KicadSchematic → KicadCanvasScene → draw_scene() → egui Painter
```
...
- `canvas/colors.rs` — Color palette for all schematic elements
...
- Screen coordinates: egui pixel coordinates (origin top-left)
