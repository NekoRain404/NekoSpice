...
use geometry::{
    ...
    KICAD_SHEET_PIN_STUB_LENGTH, KicadBoundingBoxBuilder, kicad_arc_hits_point, kicad_at_bounds,
    kicad_bezier_hits_point, kicad_circle_hits_point, kicad_closed_polyline_hits_point,
    kicad_fill_is_solid, kicad_junction_bounds, kicad_junction_radius, kicad_no_connect_arms,
    kicad_no_connect_bounds, kicad_point_bounds, kicad_point_distance, kicad_points_bounds,
    kicad_polygon_contains_point, kicad_polyline_hits_point, kicad_rectangle_hits_point,
    kicad_rotated_rect_bounds, kicad_rotated_rect_contains_point, kicad_sheet_box_bounds,
