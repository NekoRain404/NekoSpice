...
- `lib.rs` exposes the public import/report API, generic SPICE netlist parsing,
  ...
  workflows.
- `schema_import.rs` owns Schema project/source discovery and Schema schematic
  diagnostic mapping for import reports. It does not parse Schema S-expressions;
  that remains in `osl-schema`.
